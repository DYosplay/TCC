from ds_dtw_pytorch import DsDTW
import os
import gc
import inspect
import torch
...
if __name__ == '__main__':
    ...
    # model.start_train(n_epochs=N_EPOCHS, batch_size=BATCH_SIZE, comparison_files=[FILE2, FILE3, FILE4, FILE5, FILE6], result_folder=PARENT_FOLDER)
    ...
    model.new_evaluate(FILE_FINGER2, 119, result_folder=PARENT_FOLDER)
    model.new_evaluate(FILE_FINGER3, 119, result_folder=PARENT_FOLDER)
    model.new_evaluate(FILE_FINGER4, 119, result_folder=PARENT_FOLDER)
