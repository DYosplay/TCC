...
if __name__ == '__main__':
    ...
    model.new_evaluate(FILE8, 119, result_folder=PARENT_FOLDER)
    model.new_evaluate(FILE9, 119, result_folder=PARENT_FOLDER)
    model.new_evaluate(FILE10, 119, result_folder=PARENT_FOLDER)
