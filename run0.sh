...
# # Gera o sumario dos treinamentos
# python3 GerarMetricas/sumarizar.py ../CTL_S06_016_105 Comp_DeepSignDB_skilled_stylus_4vs1
# # Gera os boxplots
# python GerarMetricas/boxplot.py ../CTL_S06_016_105/resumo_Comp_DeepSignDB_skilled_stylus_4vs1.csv ../CTL_S06_016_105
# # Concatena os resultados a fim de criar o csv para o blox plot em mesma escala
# python GerarMetricas/concat_files.py "Todos/Resumo Todos.csv" ../CTL_S06_016_105/resumo_Comp_DeepSignDB_skilled_stylus_4vs1.csv
# # Gera o boxplot em mesma escala
# python GerarMetricas/box105.py "Todos/Resumo Todos.csv" Todos
