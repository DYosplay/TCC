...
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=0 python run_ds_transformer.py -ep=25 -t=ctl018 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 1 -a 1 -p 0.1 -r 0.1 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=0 python run_ds_transformer.py -ep=25 -t=ctl019 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 2 -a 1 -p 0.1 -r 0.1 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=0 python run_ds_transformer.py -ep=25 -t=ctl020 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 3 -a 1 -p 0.1 -r 0.1 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=0 python run_ds_transformer.py -ep=25 -t=ctl021 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 1 -a 1 -p 0.2 -r 0.2 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=0 python run_ds_transformer.py -ep=25 -t=ctl022 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 2 -a 1 -p 0.2 -r 0.2 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=0 python run_ds_transformer.py -ep=25 -t=ctl023 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 3 -a 1 -p 0.2 -r 0.2 -stop 26