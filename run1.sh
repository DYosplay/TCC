...
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -ep=25 -t=ctl013 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 2 -p 1 -q 0.1 -r 0.1 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -ep=25 -t=ctl014 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 1 -p 1 -q 0.1 -r 0.1 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -ep=25 -t=ctl015 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 2 -p 1 -q 0.05 -r 0.1 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -ep=25 -t=ctl016 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 1 -p 1 -q 0.1 -r 0.05 -stop 26
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -ep=25 -t=ctl017 -lr 0.01 -bs 64 -lt=compact_triplet_loss -b 0.5 -p 1 -q 0.05 -r 0.05 -stop 26