...
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -t=ds_triplet_mmd_333_tuned1.0 -val -w='epoch5.pt' -mode=finger -scene=1vs1
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:32 CUDA_VISIBLE_DEVICES=1 python run_ds_transformer.py -t=ds_triplet_mmd_333_tuned0.0 -val -w='epoch.pt' -mode=finger -scene=4vs1